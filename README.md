...
- Read/Write mode : allowing edition of tables (update and delete entities, create column, drop column… )
...
- Homegeneization of widgets, better integration in QGIS ( e.g. provider list, config window…)
