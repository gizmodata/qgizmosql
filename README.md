...
| :-- | :--: |
| Plugin name | QDuckDB |
| Plugin name slugified | qduckdb |
| Plugin name class (used in code) | Qduckdb |
| Plugin category | Database |
| Plugin description short | Plugin for using DuckDB databases in QGIS. |
| Plugin description long | This plugin adds a new data prodivder that can read DuckDB databases and display their tables as a layer in QGIS. |
| Plugin tags | duckdb,database,parquet,sql |
| Plugin icon | default_icon.png |
| Plugin with processing provider | False |
| Author name | Oslandia |
| Author organization | qgis@oslandia.com |
| Author email | qgis@oslandia.com |
| Minimum QGIS version | 3.28 |
| Maximum QGIS version | 3.99 |
| Git repository URL | https://gitlab.com/Oslandia/qgis/qduckdb |
...
- homepage: <https://gitlab.com/Oslandia/qgis/qduckdb>
...
1. Have a look to the [plugin's metadata.txt file](qduckdb/metadata.txt): review it, complete it or fix it if needed (URLs, etc.).
